...
> "Hoy el SEM funciona con talonarios manuales, no existe trazabilidad digital, los cobros son solo en efectivo, puede haber cobros indebidos, no se declara el 100 % de todos los cobros y la Municipalidad no posee datos en tiempo real."
...
- **Ausencia total de trazabilidad:** Ningún pago queda registrado electrónicamente. La Municipalidad no cuenta con datos en tiempo real sobre recaudación, ocupación de espacios ni comportamiento de la demanda.

- **Control prácticamente nulo:** La normativa prevé mecanismos de control, pero en la práctica no existen inspectores que los apliquen. En algunos casos los permisionarios no entregan el ticket al conductor; en otros, el monto cobrado no coincide con el registrado. El conductor que no desea pagar tampoco enfrenta consecuencias prácticas inmediatas.

- **Infracción frecuente y silenciosa:** La ordenanza establece claramente los horarios en que el cobro está permitido, pero su desconocimiento generalizado —tanto entre vecinos como entre algunos permisionarios— permite que cobros indebidos ocurran con frecuencia, sin que el sistema pueda prevenirlos ni detectarlos.

- **Costos operativos y fricción innecesaria:** Los permisionarios deben trasladarse físicamente a la Municipalidad para comprar los talonarios, generando desplazamientos, tiempos muertos y costos logísticos para ambas partes.

- **Exclusión de medios modernos:** El sistema actual no admite ningún medio de pago digital. Esto limita la experiencia del conductor y reduce las posibilidades de auditoría y transparencia.

# Objetivo

Desarrollar una aplicación que resuelva las problemáticas mencionadas anteriormente respetando los requisitos obligatorios.

## Digitalizar integralmente el Sistema de Estacionamiento Medido de Salta para registrar y controlar el 100 % de los cobros en tiempo real, manteniendo al permisionario como actor central del servicio y ofreciendo al conductor una experiencia de pago rápida, segura y transparente.

Este objetivo responde directamente al diagnóstico: hoy el SEM opera con talonarios manuales, cobros solo en efectivo, sin trazabilidad digital, con posibilidad de cobros indebidos y sin datos en tiempo real para la Municipalidad. Además, la solución debe integrar Mercado Pago, admitir efectivo registrado digitalmente y garantizar la continuidad de los permisionarios.

# Antecedentes

## Municipalidad (Análisis en Salta)
...
- Descripción del rol del permisionario en el nuevo sistema y cómo se garantiza su continuidad.
